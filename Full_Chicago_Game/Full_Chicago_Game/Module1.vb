Module Module1
    REM Chicago Game version Full(Light+V.10) 09/04/14 Patrick Ali 
    ...
    Sub Main()
        ...
        REM This is a call to the Game_Choice subroutine so as to take them to the Game choice screen  
        Game_Choice()
    ...
    REM Beginning of Game_Choice subroutine  

    Sub Game_Choice()

        REM This is where the player can chose whether to play the light version of the game
        REM Or if they want to play a game with more help, such as confirmation screens 

        Console.WriteLine("Hello Player and welcome to the Chicago game")
        REM This will place a space between the line below and the line above so as to make the screen look clearer  
        Console.WriteLine(" ")
        REM This tells new players or intermediate players how to access the 
        Console.WriteLine("For new players or those who have not played much")
        Console.WriteLine("please type 1 and press enter")
        REM This will place a space between the line below and the line above so as to make the screen look clearer  
        Console.WriteLine(" ")
        REM This will tell advanced players how to access the more advanced version of the game
        Console.WriteLine("For advanced players please type 2 and press enter")
        REM This will record the player’s decision so it can be used to take them where they want to go  
        ...
        If Choice = 1 Then
            ...
            Console.Clear()
            REM This is a call to the  WelcomeScreen_Light subroutine so the player can play the easier version of the game 
            WelcomeScreen()
            REM This command will activate if the player choses option 2 and will take them to an advanced version of the game 
        ElseIf Choice = 2 Then
            REM This will clear the screen and make it look less cluttered and thus more user friendly 
            Console.Clear()
            REM This is a call to the WelcomeScreen subroutine so that the player can play the more advanced version of the game
            WelcomeScreen_Light()
        ...
        ElseIf Choice > 2 Then
            ...
            REM This will clear the screen and make it look less cluttered and thus more user friendly 
            Console.Clear()
            REM This is a call to the Game_Choice subroutine so as to take them back to the Game Choice screen
        ...
        REM End of Game_Choice If statement 

    End Sub

    REM End of Game_Choice subroutine 

    REM Beginning of Basic Game

    REM Beginning of the WelcomeScreen subroutine 

    Sub WelcomeScreen()
        REM This welcomes the player to the Chicago game 
        Console.WriteLine("Welcome to the Chicago game for beginners and intermediaries")
        REM This will place a space between the line below and the line above so as to make the screen look clearer  
        Console.WriteLine(" ")
    ...
    REM End of basic game 

    REM Beginning of Advanced Game 

    REM Beginning of the WelcomeScreen_Light subroutine 

    Sub WelcomeScreen_Light()
        REM This welcomes the player to the Chicago game 
        Console.WriteLine("Welcome to the Chicago game for advanced players")
        REM This will place a space between the line below and the line above so as to make the screen look clearer  
        Console.WriteLine(" ")
        REM This tells the player how to begin the login process 
        Console.WriteLine("If you would like to play type 1 and press enter to login")
        ...
        REM Beginning of WelcomeScreen_Light If statement 
        ...
        ElseIf Choice > 2 Then
            ...
            REM This will clear the screen and make it look less cluttered and thus more user friendly 
            Console.Clear()
            REM This is a call to the WelcomeScreen_Light subroutine so as to take them back to the welcome screen
            REM So they can try and enter a correct value
            WelcomeScreen_Light()
            REM This command will activate if the player enters a numerical value less than 1
            REM This will tell the player this is not a valid option and to try again
        ...
        REM End of WelcomeScreen_Light If statement 

    End Sub

    REM End of the WelcomeScreen_Light subroutine 

    REM Beginning of UserName_Light subroutine 
    ...
    Sub UserName_Light()
        ...
        REM Beginning of UserName_Light check loop 

        REM This loop (loop1) will run 10 times each time checking the typed username against those in the player arrays 
        For loop1 = 0 To 9

            REM Beginning of UserName_Light check if statement 
            ...
            If players(loop1).user = PlayerUserName Then
                ...
                REM This will clear the screen so as to make it look less cluttered 
                Console.Clear()
                REM After having a correct username the program will call the Password_Light subroutine 
                Password_Light()
                End
            End If

            REM End of UserName_Light check if statement 

        Next

        REM End of UserName_Light check loop

        REM Beginning of UserName_Light failure if statement 
        ...
        REM End of UserName_Light failure if statement

    End Sub

    REM End of UserName_Light subroutine 

    REM Beginning of Password_Light subroutine 
    ...
    Sub Password_Light()
        ...
        REM Beginning of Password_Light failure if statement
        ...
        REM End of Password_Light failure if statement

    End Sub

    REM End of the Password_Light subroutine 

    REM Beginning of the welcome_Light subroutine 
    ...
    Sub Welcome_Light()
        ...
        If Choice = "1" Then
            REM This will clear the screen so as to make it look less cluttered 
            Console.Clear()
            REM This is a call to the Game_Light subroutine so as to take the player to their desired location
            Game_Light()
            REM This is the section that will take the player to the help screen if the correct option is selected, in this case option 2 
        ElseIf Choice = "2" Then
            REM This will clear the screen so as to make it look less cluttered 
            Console.Clear()
            REM This is a call to the Help_Light subroutine so as to take the player to their desired location
            Help_Light()
            REM This is the section that will take the player to the scoreboard if the correct option is selected, in this case option 3 
        ElseIf Choice = "3" Then
            REM This will clear the screen so as to make it look less cluttered 
            Console.Clear()
            REM This is a call to the ScoreBoard_Light subroutine so as to take the player to their desired location
            ScoreBoard_Light()
            REM This is the section that will take the player to the exit if the correct option is selected, in this case option 4 
        ElseIf Choice = "4" Then
            REM This will clear the screen so as to make it look less cluttered 
            Console.Clear()
            REM This is a call to the update_Light subroutine so as to take the player to their desired location
            update_Light()
            REM This is in the event they do not type a valid numerical option  
        ElseIf Choice > 4 Then
            REM This will clear the screen so as to make it look less cluttered 
            ...
            REM This allows them to read the above information 
            Console.ReadLine()
            REM This is a call to the Welcome_Light subroutine so they can start over  
            Welcome_Light()
            REM This is in the event they do not type a valid numerical option  
        ElseIf Choice < 1 Then
            REM This will clear the screen so as to make it look less cluttered 
    ...
    REM End of the welcome_Light subroutine 

    REM Beginning of the Game_Light subroutine 

    Sub Game_Light()

        REM Beginning of Game_Light loop
        ...
        ElseIf ComputerScore > HumanScore Then
            ...
            Console.WriteLine(" ")
            REM This will tell the player what their opponents final score is
            Console.WriteLine("Your final score is" & " " & ComputerScore)
            REM This puts a space in between each line so as to space them out and make the screen look less squashed together
            Console.WriteLine(" ")
            REM This line tells the player that their opponent has won and so they have lost 
            Console.WriteLine("Your opponent has won")
        ...
        REM This is a call to the GameChoice_Light subroutine so they can chose what to do next
        GameChoice_Light()

    End Sub

    REM End of the Game_Light subroutine 

    REM Beginning of the GameChoice_Light subroutine

    Sub GameChoice_Light()
        ...
        If Choice = "1" Then
            ...
            REM This sets the opponents score to zero so the score does not carry over into the next game if they play again 
            ComputerScore = 0
            REM This calls the Game_Light subroutine so that the player can be taken to their desired location
            Game_Light()
            REM The second section activates if the player choses option 2 which is to go back to the main menu 
        ElseIf Choice = "2" Then
            REM This updates the number of games the player has played by adding one for every game they play 
            ...
            REM This sets the opponent’s score to zero so the score does not carry over into the next game if they play again 
            ComputerScore = 0
            REM This is a call to the Welcome_Light subroutine so they can be taken to their desired location 
            Welcome_Light()
            REM The final section activates if the player choses option three which is to exit the program 
        ElseIf Choice = "3" Then
            REM This updates the number of games the player has played by adding one for every game they play 
            ...
            REM This sets the opponent’s score to zero so the score does not carry over into the next game if they play again 
            ComputerScore = 0
            REM This calls the update_Light subroutine so that the player can be taken to their desired location
            update_Light()
            REM This is in the event they do not type a valid numerical option 
        ElseIf Choice > 3 Then
            REM This will clear the screen so as to make it look less cluttered 
            ...
            REM This allows them to read the above information 
            Console.ReadLine()
            REM This is a call to the GameChoice_Light subroutine so they can start over  
            GameChoice_Light()
            REM This is in the event they do not type a valid numerical option 
        ElseIf Choice < 1 Then
            REM This will clear the screen so as to make it look less cluttered 
        ...
        REM End of GameChoice_Light if statement 

    End Sub

    REM End of the GameChoice_Light subroutine 

    REM Beginning of the Help_Light subroutine
    ...
    Sub Help_Light()
        ...
        If Choice = "1" Then
            REM This will clear the screen so as to make it look less cluttered
            Console.Clear()
            REM This calls the DetailedHelp_Light subroutine so that the player can be taken to their desired location 
            DetailedHelp_Light()
            REM The second section activates if the player choses option 2 which is to go back to the main menu 
        ElseIf Choice = "2" Then
            REM This will clear the screen so as to make it look less cluttered
        ...
        ElseIf Choice > 2 Then
            ...
            REM This allows them to read the above information 
            Console.ReadLine()
            REM This is a call to the Help_Light subroutine so they can start over  
            Help_Light()
            REM This is in the event they do not type a valid numerical option 
        ElseIf Choice < 1 Then
            REM This will clear the screen so as to make it look less cluttered 
        ...
        REM End of Help_Light Choice if statement 

    End Sub

    REM End of the Help_Light subroutine 

    REM Beginning of the DetailedHelp_Light subroutine

    Sub DetailedHelp_Light()
    ...
    Sub DetailedHelpChoice_Light()
        ...
        ElseIf Choice = "3" Then
            REM This will clear the screen so as to make it look less cluttered
            Console.Clear()
            REM This is a call to the update_Light subroutine so the player can be taken to their desired location 
            update_Light()
            REM This is in the event they do not type a valid numerical option
        ElseIf Choice > 3 Then
            REM This will clear the screen so as to make it look less cluttered 
            ...
            REM This allows them to read the above information 
            Console.ReadLine()
            REM This is a call to the DetailedHelpChoice_Light subroutine so they can start over  
            DetailedHelpChoice_Light()
            REM This is in the event they do not type a valid numerical option
        ElseIf Choice < 1 Then
            REM This will clear the screen so as to make it look less cluttered 
        ...
        REM End of DetailedHelpChoice_Light if statement 

    End Sub

    REM End of DetailedHelpChoice_Light subroutine


    REM Beginning of ScoreBoard_Light subroutine 

    Sub ScoreBoard_Light()

        REM Beginning of ScoreBoard_Light loop
        ...
        REM End of ScoreBoard_Light loop
        ...
        ElseIf Choice = "2" Then
            REM This will clear the screen so as to make it look less cluttered
            Console.Clear()
            REM This is a call to the Finish_Light subroutine so they can be taken to their desired location 
            update_Light()
            REM This is in the event they do not type a valid numerical option
        ElseIf Choice > 2 Then
            REM This will clear the screen so as to make it look less cluttered 
    ...
    REM End of ScoreBoard_Light subroutine

    REM Beginning of update_Light subroutine
    ...
    REM End of update_Light subroutine

    REM Beginning of Finish_Light subroutine
    ...
    REM End of Finish_Light subroutine

    REM End of Advanced Game 
